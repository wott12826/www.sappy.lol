...
export default function Omnia() {
  return (
    <>
      <Head>
        <title>Omnia - Sappy</title>
        <meta name="description" content="Sappy Omnia - Explore the future of decentralized gaming and collectibles." />
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-purple-50 to-indigo-100">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-12 max-w-2xl mx-auto">
              The future of decentralized gaming and collectibles is here.
            </p>
            <div className="bg-white p-8 rounded-lg shadow-sm">
              <p className="text-gray-600 mb-4">Omnia represents the convergence of:</p>
