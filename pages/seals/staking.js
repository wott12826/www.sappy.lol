...
const StatsBar = () => (
    <div className="mx-auto w-[90%] max-w-md rounded-full bg-white font-mono text-black @container/stats">
        <div className="flex w-full items-center justify-between px-[8cqw] py-[3cqw]">
            <div className="flex flex-col items-center gap-[1cqw]">
                <p className="whitespace-nowrap text-[2.5cqw]/[2.5cqw] uppercase text-gray-500">total bits</p>
                <span className="flex items-center gap-[1cqw]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 51 59" className="h-[0.8em] flex-none">
                    ...
                    <div className="text-[4cqw]/[4cqw]">36,626.7</div>
                </span>
            </div>
            <div className="h-[6cqw] w-px bg-black"></div>
            <div className="flex flex-col items-center gap-[1cqw]">
                <p className="whitespace-nowrap text-[2.5cqw]/[2.5cqw] uppercase text-gray-500">LOYALTY MULTIPLIER</p>
                <span className="flex items-center gap-[1cqw]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 51 59" className="h-[0.8em] flex-none">
                        <path fill="#E6E6E6" d="m25.398 0 25.358 14.64-25.358 14.641L.038 14.641z"></path>
                        <path fill="silver" d="m.04 14.64 25.358 14.641v29.281L.04 43.922z"></path>
                    ...
                    <div className="text-[4cqw]/[4cqw]">TBA</div>
                </span>
            </div>
            <div className="h-[6cqw] w-px bg-black"></div>
            <div className="flex flex-col items-center gap-[1cqw]">
                <p className="whitespace-nowrap text-[2.5cqw]/[2.5cqw] uppercase text-gray-500">current rate</p>
                <span className="flex items-center gap-[1cqw]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 51 59" className="h-[0.8em] flex-none">
                        <path fill="#E6E6E6" d="m25.398 0 25.358 14.64-25.358 14.641L.038 14.641z"></path>
                        <path fill="silver" d="m.04 14.64 25.358 14.641v29.281L.04 43.922z"></path>
...
const Filters = () => (
    <div className="flex w-full flex-wrap items-center gap-3 lg:gap-6">
        <div className="flex flex-row gap-[min(1.5vw,14px)] text-sm font-medium">
            <button type="button" className="flex items-center gap-[0.7em] rounded-full px-[1.2em] py-[0.5em] font-poppins bg-white text-black">
                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="12" fill="none" viewBox="0 0 19 12" className="h-[1em]">
            ...
            <button type="button" className="flex items-center gap-[0.7em] rounded-full px-[1.2em] py-[0.5em] font-poppins bg-[#3f3f3f] text-white">STAKED</button>
            <button type="button" className="flex items-center gap-[0.7em] rounded-full px-[1.2em] py-[0.5em] font-poppins bg-[#3f3f3f] text-white">UNSTAKED</button>
        </div>
        <div className="ml-auto flex h-6 items-center justify-end gap-2 text-gray-500 lg:h-8">
...
const StakingWidget = () => {
    ...
    const handleStake = () => {
        ...
        setStatus(`Staking ${amt} tokens for ${period} days...`);
    };

    return (
        <div className="mx-auto mt-8 w-full max-w-md rounded-2xl bg-[#181818] p-8 shadow-2xl flex flex-col items-center gap-4 border border-[#232323]">
            <h3 className="text-2xl font-bold mb-2">Staking Calculator</h3>
            <div className="w-full flex flex-col gap-3">
                ...
                <input
                    ...
                    className="w-full rounded-lg bg-[#222] px-4 py-3 text-lg text-white border border-[#333] focus:outline-none focus:border-blue-400 transition"
                />
                <label className="text-sm text-gray-300 mt-2">Staking Period</label>
                <select
                    value={period}
                    onChange={e => setPeriod(Number(e.target.value))}
                    className="w-full rounded-lg bg-[#222] px-4 py-2 text-white border border-[#333] focus:outline-none focus:border-blue-400 transition"
                >
                ...
                <label className="text-sm text-gray-300 mt-2">APY (Annual % Yield)</label>
                <input
                    type="number"
                    min="0"
                    step="0.1"
            ...
            <div className="w-full mt-4 bg-[#222] rounded-lg p-4 text-white text-sm flex flex-col gap-1">
            ...
            <button
                onClick={handleStake}
                className="w-full rounded-lg bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 mt-2 transition"
            >
                Stake
            </button>
            {status && <div className="mt-2 text-sm text-blue-300">{status}</div>}
        </div>
    );
};

const BackgroundText = () => (
    <div className="text-[15.625vw] font-black text-[#323232] fixed -bottom-[2vw] -left-[1vw] -z-10 h-fit leading-none" style={{ transform: 'none' }}>
    ...
    return (
        <>
            ...
            <div className="dark bg-[#111] text-white font-poppins" style={{colorScheme: 'dark'}}>
                <div className="flex min-h-screen w-screen flex-col py-[5vh]" style={{minHeight: '100dvh'}}>
                    <StakingHeader/>
                    <main className="flex w-screen grow flex-col overflow-hidden">
                        <div className="flex flex-col justify-center gap-3 px-[5vw] pb-[5vw] lg:gap-6 lg:px-[10vw] lg:pb-[1vw]">
                            <StatsBar />
                            <Filters />
                            <StakingWidget />
                        </div>
