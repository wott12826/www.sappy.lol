...
export default function MemeMachine() {
  return (
    <>
      <Head>
        <title>Meme Machine - Sappy</title>
        <meta name="description" content="Sappy Meme Machine - AI-powered meme generation platform." />
      ...
      <div className="min-h-screen bg-white">
        ...
        {/* Hero Section */}
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-yellow-50 to-orange-100">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-black mb-8 leading-tight">
              MEME MACHINE
            </h1>
            <p className="text-xl text-gray-700 mb-12 max-w-2xl mx-auto">
              Revolutionary AI-powered meme generation platform with community-driven content.
            </p>
            <div className="bg-white p-8 rounded-lg shadow-sm">
              <p className="text-gray-600 mb-4">Create, share, and discover the next viral memes.</p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                <div className="text-center">
                  <div className="bg-gray-200 h-32 rounded-lg flex items-center justify-center mb-2">
                    <span className="text-gray-500">AI Generator</span>
                  </div>
                  <p className="text-sm font-semibold text-black">AI Generation</p>
                </div>
                <div className="text-center">
                  <div className="bg-gray-200 h-32 rounded-lg flex items-center justify-center mb-2">
                    <span className="text-gray-500">Community</span>
                  </div>
                  <p className="text-sm font-semibold text-black">Community Driven</p>
                </div>
                <div className="text-center">
                  <div className="bg-gray-200 h-32 rounded-lg flex items-center justify-center mb-2">
                    <span className="text-gray-500">Sharing</span>
                  </div>
                  <p className="text-sm font-semibold text-black">Easy Sharing</p>
                </div>
              </div>
            </div>
          </div>
