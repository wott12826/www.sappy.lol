  ...
  return (
    <>
      ...
      <div className="fixed right-4 top-1/2 -translate-y-1/2 z-50 hidden lg:flex flex-col space-y-4">
        <a href="https://x.com/MonkzArtStudio" target="_blank" rel="noopener noreferrer" className="text-white p-2 rounded-full bg-black/50 hover:bg-white hover:text-black transition-colors">
        <img src="/images/seals/x_logo.png" alt="Twitter" className="w-5 h-5" /></a>
        <a href="https://t.me/MonkzArtStudio" target="_blank" rel="noopener noreferrer" className="text-white p-2 rounded-full bg-black/50 hover:bg-white hover:text-black transition-colors">
        <img src="/images/seals/telegram_icon.png" alt="Telegram" className="w-5 h-5" /></a>
        <a href="https://dexscreener.com/solana/776ahe4epw2y1h5gbtfjxdajvbsbdn2oifsyrwkhdyp5" target="_blank" rel="noopener noreferrer" className="text-white p-2 rounded-full bg-black/50 hover:bg-white hover:text-black transition-colors">
        ...
        <main>
          ...
          <section id="landing" className="relative overflow-hidden px-[5vw] md:px-[7.5vw] 2xl:px-[10vw] h-[max(100svh,100vw/3840*1771)] bg-[#111]/90 @container">
            <header className="mb-12 flex h-[10vh] w-full lg:mb-4">
              <div className="absolute inset-x-0 top-[5vh] z-50 hidden w-full items-center justify-between px-[5vw] text-[1vw] font-semibold tracking-[0.1vw] text-white lg:flex">
                ...
                <a className="flex items-center justify-center rounded-[12px] bg-white px-2 py-1 shadow-lg hover:bg-gray-300 text-[1vw] font-bold text-[#111] whitespace-nowrap" 
                   href="https://swap.pump.fun/?input=So11111111111111111111111111111111111111112&output=C46wBrKJ5idsy8evj3mNp37BFjKkKWtXAsx6GSDmpump">
                  Buy Monkz
                </a>
              </div>
            ...
            <div className="absolute top-[13vh] left-1/2 -translate-x-1/2 z-10 flex flex-col items-center justify-center aspect-[21/9] h-[50vh] max-w-[90vw] @container">
              {/* Удаляю центральный градиентный текст */}
            </div>
          </section>
