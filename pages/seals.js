        ...
        <main>
          ...
          <section id="landing" className="relative overflow-hidden px-[5vw] md:px-[7.5vw] 2xl:px-[10vw] h-[max(100svh,100vw/3840*1771)] bg-[#111]/90 @container">
            ...
            <div className="absolute top-[13vh] left-1/2 -translate-x-1/2 z-10 flex flex-col items-center justify-center aspect-[21/9] h-[50vh] max-w-[90vw] @container">
              <h1 className="text-5xl md:text-7xl font-extrabold uppercase text-center mb-4 bg-gradient-to-r from-gray-900 via-gray-700 to-gray-300 bg-clip-text text-transparent drop-shadow-[0_4px_16px_rgba(0,0,0,0.35)]">COOLEST THING ON THE INTERNET</h1>
              <p className="text-2xl md:text-3xl text-center mb-1 font-semibold bg-gradient-to-r from-gray-900 via-gray-700 to-gray-300 bg-clip-text text-transparent drop-shadow-[0_4px_16px_rgba(0,0,0,0.35)]">Where chaos meets character.</p>
              <p className="text-2xl md:text-3xl text-center font-semibold bg-gradient-to-r from-gray-900 via-gray-700 to-gray-300 bg-clip-text text-transparent drop-shadow-[0_4px_16px_rgba(0,0,0,0.35)]">Monkz are here.</p>
            </div>
          </section>
          ...
          <section id="gaming" className="relative flex flex-col items-center justify-center py-12 lg:py-24 px-4 md:px-12 bg-white overflow-hidden">
            ...
            <div className="relative z-20 flex flex-col lg:flex-row items-start w-full max-w-6xl mx-auto gap-6 lg:gap-12">
              ...
              <div className="info-card relative bg-[#111]/80 text-white max-w-md p-6 lg:p-8 order-3" style={{clipPath: 'polygon(0 0, 100% 0, 95% 100%, 5% 100%)'}}>
                <p className="mb-4 text-sm lg:text-base">We're bringing <span className="highlight bg-[#111] text-white px-1 rounded">fresh ideas</span> and daring features into long-loved genres, creating thousand hour experiences that are too fun to put down.</p>
                <p className="mb-4 text-sm lg:text-base">Our mission is to bring spirit back into gaming and power back into the hands of players by breaking free from the traditional player ⇔ publisher ⇔ developer relationship. In the process, we'll be <span className="highlight bg-[#111] text-white px-1 rounded">creating beloved and memorable</span> IPs that last a lifetime.</p>
              </div>
            </div>
          </section>
