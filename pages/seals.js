        ...
        <main>
          ...
          <section id="landing" className="relative overflow-hidden px-[5vw] md:px-[7.5vw] 2xl:px-[10vw] h-[max(100svh,100vw/3840*1771)] bg-[#111]/90 @container">
            ...
            <div className="absolute top-[13vh] left-1/2 -translate-x-1/2 z-10 flex flex-col items-center justify-center aspect-[21/9] h-[50vh] max-w-[90vw] @container">
              <h1 className="gradient-text-horizontal drop-shadow-glow text-5xl md:text-7xl font-extrabold uppercase text-center mb-4 drop-shadow-[0_4px_16px_rgba(0,0,0,0.35)]">
                COOLEST THING ON THE INTERNET<br/>
                <span className="block text-2xl md:text-3xl font-semibold normal-case mt-2 gradient-text-horizontal drop-shadow-glow">Where chaos meets character.<br/>Monkz are here.</span>
              </h1>
            </div>
          </section>
